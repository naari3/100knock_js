...
var imageinfo = "https://commons.wikimedia.org/w/api.php?action=query&titles=File:Albert%20Einstein%20Head.jpg&prop=imageinfo";
...
zlib.gunzip(gzipContent, function (err, binary) {
  ...
  var imgurl = require('http').get("http://commons.wikimedia.org/w/api.php?action=query&titles=File:"+encodeURIComponent(tempdict["国旗画像"])+"&prop=imageinfo", function(res) {
